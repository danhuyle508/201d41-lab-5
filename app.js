...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for(var i =0; i < multArr.length; i++){
    ...
    console.log('the sum of the array', productOfArray)
  }
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  var productOfArray = 1;
  var sentence = "The numbers ";
  for(var i =0; i < dynamicArray.length; i++){
    sentence = sentence + dynamicArray[i];
    if(i !== (dynamicArray.length -1)){
      sentence = sentence + ',';
    }
    productOfArray = multiply(productOfArray,dynamicArray[i])[0];
    console.log('the product of the array', productOfArray)
  };
  return [productOfArray, sentence + ' have a product of ' + productOfArray + '.'];
}
